# Django Orlycommerce Website with Payment
This is a Orlycommerce e-commerce website built with Django (Ptyhon) and Stripe is added as payment processor.
...
```
$  git clone https://github.com/vijaythapa333/Orlycommerce.git
```
